...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Spider.last_update'
        db.alter_column(u'barrow_spider', 'last_update', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Spider.last_update'
        db.alter_column(u'barrow_spider', 'last_update', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True))
