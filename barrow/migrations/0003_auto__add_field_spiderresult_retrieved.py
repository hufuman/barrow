...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SpiderResult.retrieved'
        db.add_column(u'barrow_spiderresult', 'retrieved',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SpiderResult.retrieved'
        db.delete_column(u'barrow_spiderresult', 'retrieved')
