...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'SpiderResult', fields ['retrieved']
        db.create_index(u'barrow_spiderresult', ['retrieved'])

        # Adding index on 'SpiderResult', fields ['create_time']
        db.create_index(u'barrow_spiderresult', ['create_time'])


    def backwards(self, orm):
        # Removing index on 'SpiderResult', fields ['create_time']
        db.delete_index(u'barrow_spiderresult', ['create_time'])

        # Removing index on 'SpiderResult', fields ['retrieved']
        db.delete_index(u'barrow_spiderresult', ['retrieved'])
